...
export default function Header() {
  return (
    <header className="relative w-full min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative w-full min-h-screen bg-cover bg-center flex items-center justify-center overflow-hidden" 
               style={{backgroundImage: 'radial-gradient(100% 316.05% at 100% 97.64%, #081319 0%, rgba(8, 19, 25, 0) 100%), url(/cf1d33eaeae67aa8f6670e70d21deaa092c3e9ad.jpg)'}}>
        
        {/* Hero Overlay */}
        <div className="absolute w-full md:w-1/2 lg:w-2/3 h-full right-0 top-0" 
             style={{background: 'radial-gradient(100% 240.94% at 100% 100%, rgba(8, 19, 25, 0.75) 0%, rgba(8, 19, 25, 0) 100%)'}}></div>
        ...
        <div className="relative z-10 w-full px-4 md:px-6 lg:px-[100px] flex flex-col items-start gap-6 md:gap-8 lg:gap-12">
          ...
          <div className="w-full flex justify-end">
            <p className="text-white text-base md:text-lg lg:text-xl xl:text-2xl font-normal leading-relaxed text-right max-w-2xl">
              We help European SMBs boost revenue and maximize operational efficiency by providing custom AI solutions and expert engineering teams.
            </p>
          </div>
        </div>
